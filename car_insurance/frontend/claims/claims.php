...
<div id="mySidenav" class="sidenav">
    ...
    <div class="container my-5">
        <h1>Claims</h1>
        <a class="btn btn-primary" href="create.php" role="button">Add Claim</a>
        <br>
        ...
        <form action="" method="GET" class="my-3">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Search by Claim ID" name="search"
                    value="<?php echo isset($_GET['search']) ? $_GET['search'] : ''; ?>">
                <button class="btn btn-outline-secondary" type="submit">Search</button>
                <?php if (isset($_GET['search']) && !empty($_GET['search'])): ?>
                    <a class="btn btn-outline-secondary" href="claims.php" role="button">Clear</a>
                <?php endif; ?>
            </div>
        </form>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM claimdetails $search_query LIMIT $limit OFFSET $offset";
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class='btn btn-danger' href='delete.php?id=" . $row['ID'] . "&page=" . $page . "' role='button'>Delete</a>
                </td>
            </tr>";
                    }
                } else {
                ...
                $sql_total = "SELECT COUNT(*) AS total FROM claimdetails $search_query";
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination justify-content-center">
                <li class="page-item <?php echo $page <= 1 ? 'disabled' : ''; ?>">
                    <a class="page-link" href="?page=1<?php echo $search ? '&search=' . $search : ''; ?>"
                        aria-label="First">
                ...
                <?php if ($page > 2): ?>
                    <li class="page-item"><a class="page-link"
                            href="?page=<?php echo $page - 2; ?><?php echo $search ? '&search=' . $search : ''; ?>"><?php echo $page - 2; ?></a>
                    </li>
                <?php endif; ?>
                <?php if ($page > 1): ?>
                    <li class="page-item"><a class="page-link"
                            href="?page=<?php echo $page - 1; ?><?php echo $search ? '&search=' . $search : ''; ?>"><?php echo $page - 1; ?></a>
                    </li>
                <?php endif; ?>
