...
<div id="mySidenav" class="sidenav">
    ...
    <div class="container my-5">
        <h1>Cars</h1>
        <a class="btn btn-primary" href="create.php" role="button">Add Car</a>
        <br>
        ...
        <form action="" method="GET" class="my-3">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Search by Car ID" name="search"
                    value="<?php echo isset($_GET['search']) ? $_GET['search'] : ''; ?>">
                <button class="btn btn-outline-secondary" type="submit">Search</button>
                <?php if (isset($_GET['search']) && !empty($_GET['search'])): ?>
                    <a class="btn btn-outline-secondary" href="cars.php" role="button">Clear</a>
                <?php endif; ?>
            </div>
        </form>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM cardetails $search_query LIMIT $limit OFFSET $offset";
            ...
            <tr>
                ...
                $sql_total = "SELECT COUNT(*) AS total FROM cardetails $search_query";
